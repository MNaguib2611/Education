			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="{{url('/teachers')}}">Teachers</a></li>
        ...
        <div class="container">
            <div class="row">
				...
				<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team">
						<div class="team-img">
                        <img src="{{url('assests/images/').'/'.$teacher->image}}">
							<div class="social">
								<ul>
                        ...
                        <span class="post">{{$teacher->position}}</span>
						</div>
					</div>
                </div>
