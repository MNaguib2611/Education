        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="{{url('assests/images/blog_1.jpg')}}" alt="" class="img-fluid">
						</div>
						<div class="course-br">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="{{url('assests/images/blog_2.jpg')}}" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
				...
				<div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="{{url('assests/images/blog_3.jpg')}}" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
            ...
            <div class="row">
				<div class="col-lg-4 col-md-6 col-12">
                   <div class="course-item">
						<div class="image-blog">
                        <img src="{{url('assests/images/blog_4.jpg')}}" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="{{url('assests/images/blog_5.jpg')}}" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="course-item">
						<div class="image-blog">
							<img src="{{url('assests/images/blog_6.jpg')}}" alt="" class="img-fluid">
						</div>
						<div class="course-br">
							<div class="course-title">
